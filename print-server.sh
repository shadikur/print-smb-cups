...
wget https://raw.githubusercontent.com/shadikur/print-smb-cups/main/smb.conf -O /etc/samba/smb.conf 
...
wget https://raw.githubusercontent.com/shadikur/print-smb-cups/main/cupsd.conf -O /etc/cups/cupsd.conf
